...
define("SITE_NAME", "Aireen Bags Collection");
...
define("APP_ID", "8e7d90641a1adc6d9302dec03227d9e9");
...
define('USER_PHOTO',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['gambar'] : null ));
