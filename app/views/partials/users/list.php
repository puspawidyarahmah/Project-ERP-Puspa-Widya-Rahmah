                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-negara"> Negara</th>
                                                <th  class="td-instansiasi"> Instansiasi</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-negara">
                                                        <span  data-value="<?php echo $data['negara']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="negara" 
                                                            data-title="Enter Negara" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
                                                    ...
                                                    <td class="td-instansiasi">
                                                        <span  data-value="<?php echo $data['instansiasi']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="instansiasi" 
                                                            data-title="Enter Instansiasi" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
