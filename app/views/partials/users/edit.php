                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-negara"  value="<?php  echo $data['negara']; ?>" type="text" placeholder="Enter Negara"  required="" name="negara"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-instansiasi"  value="<?php  echo $data['instansiasi']; ?>" type="text" placeholder="Enter Instansiasi"  required="" name="instansiasi"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
