                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-kas"  value="<?php  echo $data['kas']; ?>" type="number" placeholder="Enter Kas" step="1"  required="" name="kas"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-pesan"  value="<?php  echo $data['pesan']; ?>" type="text" placeholder="Enter Pesan"  required="" name="pesan"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
