	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				penjualan.users_id LIKE ? OR 
				penjualan.perusahaan_id LIKE ? OR 
				penjualan.nama_pembeli LIKE ? OR 
				penjualan.barang_id LIKE ? OR 
				penjualan.status LIKE ? OR 
				penjualan.traffics_id LIKE ? OR 
				penjualan.provinsi LIKE ? OR 
				penjualan.kabupaten LIKE ? OR 
				penjualan.kecamatan LIKE ? OR 
				penjualan.kelurahan LIKE ? OR 
				penjualan.jumlah LIKE ? OR 
				penjualan.harga_asli LIKE ? OR 
				penjualan.harga_jual LIKE ? OR 
				penjualan.total_biaya LIKE ? OR 
				penjualan.keuntungan LIKE ? OR 
				penjualan.created_at LIKE ? OR 
				penjualan.updated_at LIKE ?
			)";
			$search_params = array(
