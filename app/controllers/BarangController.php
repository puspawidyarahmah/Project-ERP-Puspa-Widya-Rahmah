...
class BarangController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				barang.gambar LIKE ? OR 
				barang.perusahaan_id LIKE ? OR 
				barang.satuan LIKE ? OR 
				barang.harga_asli LIKE ? OR 
				barang.harga_jual LIKE ? OR 
				barang.created_at LIKE ? OR 
				barang.updated_at LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("nama","deskripsi","gambar","perusahaan_id","satuan","harga_asli","harga_jual","created_at","updated_at");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","nama","deskripsi","gambar","perusahaan_id","satuan","harga_asli","harga_jual","created_at","updated_at");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'nama' => 'required',
