...
class IndexController extends BaseController{
	...
	function register($formdata = null){
		if($formdata){
			...
			$db = $this->GetModel();
			$tablename = $this->tablename;
			$fields = $this->fields = array("name","email","email_verified_at","umur","alamat","negara","instansiasi","perusahaan_id","role","gambar","deskripsi","password","remember_token","created_at","updated_at"); //registration fields
